...
ggplot(dat, aes(depressionRev,color=raceEthnicity,fill=raceEthnicity)) + geom_bar(alpha=.5,position = position_dodge())
```
...
ggplot(dat, aes(anxietyRev,color=raceEthnicity,fill=raceEthnicity)) + geom_bar(alpha=.5,position = position_dodge())
```
...
ggplot(dat, aes(depressionRev,color=marital,fill=marital)) + geom_bar(alpha=.5,position = position_dodge())
```

Individuals who are married will experience lower levels of of anxiety
```{r}
kruskal.test(anxietyRev ~ marital, data= dat)
ggplot(dat, aes(anxietyRev,color=marital,fill=marital)) + geom_bar(alpha=.5,position = position_dodge())
```
