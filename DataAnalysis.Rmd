...
ggplot(dat, aes(depressionRev,color=raceEthnicity,fill=raceEthnicity)) + geom_density()
```
...
ggplot(dat, aes(anxietyRev,color=raceEthnicity,fill=raceEthnicity)) + geom_density()
```
