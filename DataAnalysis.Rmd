...
#giving us silly knitting errors
```
...
ggplot(dat, aes(depressionRev,color=as.factor(physicalHealthRev),fill=as.factor(physicalHealthRev))) + geom_bar(alpha=.5,position = position_dodge())
```
